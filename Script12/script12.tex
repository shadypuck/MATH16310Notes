...
\begin{exercise}[Power Rule]\label{exr:12.8}\leavevmode
...
\begin{exercise}[Sum, Product, and Quotient Rules]\label{exr:12.9}
...
\begin{theorem}[Chain Rule]\label{trm:12.10}
...
\begin{theorem}[Rolle's Theorem]\label{trm:12.15}
...
\begin{corollary}[Mean Value Theorem]\label{cly:12.16}
...
\begin{corollary}[First Derivative Test]\label{cly:12.17}\marginnote{\emph{4/6:}}
...
\begin{theorem}[Inverse Function Theorem]\label{trm:12.21}
