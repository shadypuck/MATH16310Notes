...
\begin{lemma}[Cauchy-Schwarz Inequality]\label{lem:18.9}\leavevmode
...
\marginnote{7/28:}Now we revisit compactness, but in $\R^n$. For our purposes, the key result is Corollary \ref{cly:18.48}.
...
\begin{theorem}[Heine-Cantor Theorem in $\R^n$]\label{trm:18.43}
...
\begin{theorem}[Extreme Value Theorem in $\R^n$]\label{trm:18.44}
...
% Exr 18.32 and Cly 18.39 for continuity.
...
\begin{theorem}[Heine-Borel Theorem in $\R^n$]\label{trm:18.52}
