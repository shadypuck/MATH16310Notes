...
\begin{definition}\label{dfn:18.14}
    A subset $U\subset\R^n$ is \textbf{open} if for all $\x\in U$, there exists an open rectangle $R$ such that $\x\in R\subset U$. A subset $C\in\R^n$ is closed if its compliment is open.
\end{definition}
