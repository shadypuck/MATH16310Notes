...
\section{Journal}
\begin{theorem}[First Fundamental Theorem of Calculus --- Derivative of Integrals]\label{trm:14.1}\marginnote{\emph{5/4:}}
...
\begin{theorem}[Second Fundamental Theorem of Calculus --- Integral of Derivatives]\label{trm:14.4}\marginnote{\emph{5/6:}}
...
\begin{corollary}[Integration by Parts]\label{cly:14.5}
