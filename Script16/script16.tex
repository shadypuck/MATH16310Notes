...
\begin{theorem}[Divergence Test]\label{trm:16.4}
...
\begin{theorem}[Cauchy Convergence Test]\label{trm:16.5}
...
\begin{theorem}[Geometric Series Test]\label{trm:16.7}\marginnote{\emph{5/25:}}
    Let $-1<x<1$. Then
    \begin{equation*}
...
\begin{theorem}[Alternating Series Test]\label{trm:16.12}
...
\begin{theorem}[Direct Comparison Test]\label{trm:16.13}
...
\begin{theorem}[Ratio Test]\label{trm:16.15}
...
\begin{theorem}[Root Test]\label{trm:16.16}
