...
\begin{theorem}[Monotone Convergence Theorem]\label{trm:15.14}
...
\begin{theorem}[Bolzano-Weierstrass Theorem]\label{trm:15.18}
...
\begin{theorem}[Cauchy Completeness Theorem]\label{trm:15.19}
